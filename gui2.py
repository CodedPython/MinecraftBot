...
class BotGUI:
    def __init__(self):
        ...
        self.toggle_btn = ttkb.Button(self.root, text="Switch to Light Theme", command=self.toggle_theme)
    ...
    def create_custom_tab(self):
        ...
        ttkb.Button(custom_frame, text="Dig Down", command=self.send_dig_down_custom).grid(row=0, column=2)

        ttkb.Label(custom_frame, text="Fight Player (name):").grid(row=1, column=0, sticky="e")
